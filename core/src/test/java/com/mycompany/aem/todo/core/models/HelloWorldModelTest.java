 ...
 */
package com.mycompany.aem.todo.core.models;
...
import com.mycompany.aem.todo.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "aem-todo/components/helloworld");
